...
<section className="usa-cost" style={{ maxWidth: "1100px", margin: "60px auto", padding: "0 20px" }}>
  ...
  <div className="student-life-image">
    <img src="/assets/usa/usa-student-life.jpg" alt="Student Life in USA" />
      ...
      <section className="usa-summary">
        <p>
          Planning to study in the USA? Our consultancy assists Indian students with admissions,
          scholarships, visa applications, and career guidance to ensure a successful study abroad journey.
        </p>
      </section>
    </div>
  );
