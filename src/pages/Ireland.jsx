    ...
    {[
      ...
      <section className="ireland-universities">
        ...
        <div className="universities-grid">
          {[
            { name: "Trinity College Dublin", img: "/assets/ireland/universities/trinity.jpg" },
            { name: "University College Dublin (UCD)", img: "/assets/ireland/universities/ucd.jpg" },
            { name: "University College Cork (UCC)", img: "/assets/ireland/universities/ucc.jpg" },
            { name: "Dublin City University (DCU)", img: "/assets/ireland/universities/dcu.jpg" },
            { name: "National University of Ireland Galway (NUIG)", img: "/assets/ireland/universities/nuig.jpg" },
            { name: "Maynooth University", img: "/assets/ireland/universities/maynooth.jpg" },
            { name: "Technological University Dublin", img: "/assets/ireland/universities/tudublin.jpg" },
            { name: "Royal College of Surgeons in Ireland", img: "/assets/ireland/universities/rcsi.jpg" },
          ].map((uni, i) => (
      ...
      <section className="ireland-faq">
        ...
        <section className="ireland-summary">
          <p>
            “Looking to study in Ireland? Our consultancy assists Indian students with university 
            admissions, scholarships, visa processing, and career guidance to make your journey seamless."
          </p>
        </section>
      </section>
    </div>
